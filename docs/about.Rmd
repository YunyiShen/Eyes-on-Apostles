...
This app is part of the collaborative project between Apostle Island National Lakeshore (APIS) and University of Wisconsin-Madison (UW-Madison) to visualize the data collected by the camera trap grid on the islands under project "Eyes on Apostles". The source code of this app is open to public [here](https://github.com/YunyiShen/Eyes-on-Apostles) under MIT license. 

### Bug report, feature request and contribution

- To report a bug or request a feature, use github's issue [here](https://github.com/YunyiShen/Eyes-on-Apostles/issues).
...
We expect you to follow [Ubuntu code of conduct](https://ubuntu.com/community/code-of-conduct)
